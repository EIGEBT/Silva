...
ControllerAll = false
local ListSudos ={Sudo_Id,1804133252,2088955578,1428353385}  
...
elseif UserId == 2088955578 then  
Status = 'مبرمج السورس'
elseif UserId == 1428353385 then  
Status = 'مطور السورس'
...
elseif tonumber(msg.sender.user_id) == 2088955578 then
msg.Name_Controller = 'مبرمج السورس'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1428353385 then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/Saidi_source'}, },}}
...
NamesBot = (Redis:get(Saidi.."Saidi:Name:Bot") or "ميزو")
...
{
{text = Jabwa, url = 't.me/Saidi_source'}, 
},
{
{text = Grosupsw, url = 't.me/Saidi_source'}, 
},
{
{text = Usperos, url = 't.me/Saidi_source'}, 
},
}
...
data = {
{
{text = '.َ ‹ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶 ⁦⁦.𖨬', url = 't.me/Saidi_source'}, 
},
}
}
...
keyboard.inline_keyboard = {
{
{text = '.َ ‹ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶 ⁦⁦.𖨬', url = "https://t.me/Saidi_source"}
},
}
...
local T =[[
⦑ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ᴍᴇᴢᴏ⦒ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '˹  𝒁𝑰𝑨𝑫 ⁦. 𓌗', url = "https://t.me/A_N_T_N_O_l"},{text = '˹  𝑴𝑬𝒁𝑶 ⁦. 𓌗', url = "https://t.me/Saidi508"}
},
{
{text = '˹  𝑩𝑨𝑵𝑫𝑨 ⁦. 𓌗', url = "https://t.me/Q_o_ll"},{text = '˹  𝑻𝑾𝑺𝑶. 𓌗', url = "https://t.me/Saidi617"}
},
{
{text = '.َ ‹ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶 ⁦⁦.𖨬', url = "https://t.me/Saidi_source"}
},
...
photo = "https://t.me/Saidi508"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ ˹  𝑴𝑬𝒁𝑶 ⁦. 𓌗 \n ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𝅘𝅥𝅯 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '˹  𝑴𝑬𝒁𝑶 ⁦. 𓌗', url = "https://t.me/Saidi508"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
data = {
{
{text = '.َ ‹ ??𝑶𝑼𝑹𝑪𝑬 𝑴𝑬𝒁𝑶 ⁦⁦.𖨬', url = 't.me/Saidi_source'}, 
},
}
}
...
local NamesBot = (Redis:get(Saidi.."Saidi:Name:Bot") or "ميزو")
local BotName = {
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/Saidi_source'}, 
},
{
...
if text == (Redis:get(Saidi.."Saidi:Name:Bot") or "ميزو") then
local photo = LuaTele.getUserProfilePhotos(Saidi)
local ban = LuaTele.getUser(Saidi)
for Name_User in string.gmatch(ban.first_name, "[^%s]+" ) do
ban.first_name = Name_User
...
local CmdStart = '*\n ◉ أهلآ بك في بوت '..(Redis:get(Saidi.."Saidi:Name:Bot") or "ميزو")..
