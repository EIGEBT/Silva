...
local msg_id = msg.id
Redis:incr(Timo..'Timo:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
local Contact_Group = Redis:get(Timo.."Timo:Lock:Contact"..msg_chat_id)
...
if Redis:get(Timo.."Timo:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '❴ الغاء الامر ❵' then   
Redis:del(Timo.."Timo:Change:Name:Bot"..msg.sender.user_id) 
...
--download('https://raw.githubusercontent.com/M2007A/JEKA/master/Timo.lua','Timo.lua')
...
Redis:set(Timo.."Timo:Zhrf:Sasa"..msg_chat_id,true) 
...
Redis:del(Timo.."Timo:Zhrf:Sasa"..msg_chat_id) 
...
local T = '* 𝑮𝑹𝑶𝑼𝑷 𝑶𝑾𝑵𝑬𝑹:- *['..ban.first_name..'](tg://user?id='..ban.id..')**'
if photo.total_count > 0 then
keyboard = {} 
keyboard.inline_keyboard = {
{
...
data = {
{
{text = '• ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠѕ •', url = 't.me/SU_SELVA'}, 
},
}
}
...
LuaTele.sendText(msg_chat_id,msg_id,'*⎈ ⦙  عدد جهاتك يبشا = '..(Redis:get(Timo.."Timo:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
┇[ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠѕ](http://t.me/SU_SELVA)
┇▱▰▱▰▱▰▱▰▱▰▱▰▱
...
{
{text = '• - ѕɪᴢᴇʀ - •', url = "https://t.me/ttccss"},{text = '• - ᴊᴀʙᴡᴀ - •', url = "https://t.me/J_A_B_W_A"}
},
{
{text = '• • ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠѕ • •', url = "https://t.me/SU_SELVA"}
},
{
{text = '𓆩اضف البوت لمجموعتك𓆪', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
{
{text = '• ɢʀᴏ𝗎ᴘ •', url = "https://t.me/br_selva"},{text = '• - ᴄʜᴀɴɴᴇᴛ - •', url = "https://t.me/SU_SELVA"}
},
{
{text = '- ʙᴏᴛ ᴛɪᴍᴏ -',url="t.me/Timo8Bot"}
},
}
local msgg = msg_id/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = '- ѕɪᴢᴇʀ -', url = "https://t.me/ttccss"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Name = '𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚈𝙾𝚂𝙰𝚁𝙰𝚃 ᴊᴀʙᴡᴀ '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '- ᴊᴀʙᴡᴀ -', url = "https://t.me/J_A_B_W_A"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '- ʙᴏᴛ -', url = "https://t.me/LC6BOT"}
},
{
{text = '𓆩اضف البوت لمجموعتك𓆪', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
keyboard.inline_keyboard = {
{
{text = '- ᴄʜᴀɴɴᴇᴛ-',url="t.me/SU_SELVA"}
},
{
{text = '𓆩اضف البوت لمجموعتك𓆪', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
return LuaTele.sendText(msg_chat_id,msg_id,'*هاي ورحمه الله وبركاته 😹💔*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*مع السلامه في رعايه الله 😹💔🎶*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*ايوا خدها خاص واخربها يوسخ 🥺💔*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*بتضحك علي خبتك 🌝❤️*',"md",false, false, false, false, reply_markup)
end
if text == '😹' or text == '😹' then
if not Redis:get(Timo.."Timo:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,'*يخلاثي علي العسل 🙂❤️*',"md",false, false, false, false, reply_markup)
end
if text == '💋' or text == '💋💋' then
if not Redis:get(Timo.."Timo:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
...
Redis:setex(Timo.."Timo:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
'اسمي '..NamesBot..' يا مزه ❤️🌎',
'انا بوت اسمي '..NamesBot..' 🙄',
'انا بوت اسمي '..NamesBot..' وبحبك 🌚🖐🏼',
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Timo.."Timo:photo:Rank"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Timo.."Timo:photo:Rank"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
