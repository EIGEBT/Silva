...
ControllerAll = false
local ListSudos ={Sudo_Id,5133554730,1982659756,34563}  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/YY_XXY'}, },}}
...
NamesBot = (Redis:get(Timo.."Timo:Name:Bot") or "جمر")
...
{
{text = Jabwa, url = 't.me/YY_XXY'}, 
},
{
{text = Grosupsw, url = 't.me/YY_XXY'}, 
},
{
{text = Usperos, url = 't.me/YY_XXY'}, 
},
}
...
if not Redis:get(Timo.."Timo:BotFree") then
...
data = {
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝒁𝑶𝑲𝑨', url = 't.me/YY_XXY'}, 
},
}
}
...
keyboard.inline_keyboard = {
{
{text = '•𝒁𝑶𝑲𝑨•', url = "https://t.me/VV_GG_Z"}
},
}
local msgg = msg_id/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = '𝑴𝑹𝑨𝑻 𝒁𝑶𝑲𝑨', url = "https://t.me/xx_merat_ZOKA_xx"}
},
}
local msgg = msg_id/2097152/0.5
...
local NamesBot = (Redis:get(Timo.."Timo:Name:Bot") or "جمر")
local BotName = {
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/YY_XXY'}, 
},
{
...
if text == (Redis:get(Timo.."Timo:Name:Bot") or "جمر") then
local photo = LuaTele.getUserProfilePhotos(Timo)
local ban = LuaTele.getUser(Timo)
for Name_User in string.gmatch(ban.first_name, "[^%s]+" ) do
ban.first_name = Name_User
...
local CmdStart = '*\n ✠ أهلآ بك في بوت '..(Redis:get(Timo.."Timo:Name:Bot") or "جمر")..
