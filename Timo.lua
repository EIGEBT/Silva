...
msg.Name_Controller = 'المبرمج سيلفا'
...
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج سيلفا' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ᪣ عذرا لا تستطيع حظر عام𓄼 "..Controller(msg_chat_id,UserId_Info.id).." 𓄹*","md",true)  
end
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج سيلفا' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ᪣ عذرا لا تستطيع حظر عام𓄼 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 𓄹*","md",true)  
end
...
if Controller(msg_chat_id,UserId) == 'المبرمج سيلفا' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*  ᪣ عذرا لا تستطيع كتم عام𓄼 "..Controller(msg_chat_id,UserId).." 𓄹*","md",true)  
end
...
{
{text = '𓄼•ѕᴇʟᴠᴀ•𓄹', url = "https://t.me/tt_tt_4"}
},
{
{text = '𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹', url = "https://t.me/SU_SELVA"}
},
...
elseif text == 'سيلفا' or text == 'المبرمج سيلفا' or text == 'مبرمج السورس' or text == 'جبسكي' or text == 'المبرمج جبسكي' then
photo = "https://t.me/sorcy/8"
local Name = 'المبرمج سيلفا للتواصل معاه اتبع الزر ال في الاسفل ⇓⇑ '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼•ѕᴇʟᴠᴀ•𓄹', url = "https://t.me/tt_tt_4"}
